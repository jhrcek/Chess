 ...
 * @author xhrcek
 */
public class OldMain extends JFrame implements ActionListener {

    /**
     * Creates new instance of OldMain class.
     */
    public OldMain() {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == loadFileItem) {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                myGameSaver = new OldGameSaver(this, currentlyWiewedGame, selectedFile);
    ...
    public class NewGameAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            currentlyWiewedGame = new OldGameStateMutable();
...
/////------------PRIVATE IMPLEMENTATION--------------------////////
    private void initComponents() {
        ...
        currentlyWiewedGame = new OldGameStateMutable();
        stateModel = new OldGameModelImpl(currentlyWiewedGame);
        chessboardComponent = new OldChessboardComponent(stateModel);
        chessboardComponent.addMoveSelectedEventListener(stateModel);

        //create okno na zobrazovani tahu
        moveDisplayWindow = new OldMoveDisplayWindow(stateModel);
    ...
    private static ImageIcon createNavigationIcon(String imageName) {
        ...
        java.net.URL imageURL = OldMain.class.getResource(imgLocation);
    ...
    private void handleOpenedFile(File f) throws FileNotFoundException {
        ...
        gamesTableModel = new OldGamesTableModel(parsedGames);
     ...
     */
    private OldGamesTableModel gamesTableModel;
    /**
     * List of games loaded form some pgn file (if any is opened).
     */
    private List<OldGameStateMutable> parsedGames;
    ...
    private OldGameSaver myGameSaver;
    //buttons
